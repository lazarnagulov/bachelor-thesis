...
#dodatak(
    table(
        ...
        [Двоструко упућивање], [Механизам у коме се избор методе која ће бити извршена врши у изршном времену на основу типова два објекта: објекта који прима позив и објекта који се прослеђује као аргумент.],
    ),
)
