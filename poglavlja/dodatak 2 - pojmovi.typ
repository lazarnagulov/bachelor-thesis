...
#dodatak(
    table(
        ...
        [Засебно превођење], [Метод превођења програмског кода где се изворне датотеке компајлирају независно, чиме се убрзава развој јер нема потребе за поновним превођењем целог система.],
        ...
        [Шаблон], [Активна семантичка јединица над којом се извршава генерација.],
    ),
)
