...
= Увод
Осигурање квалитета у развоју софтверских система ослања се на континуирано тестирање. Аутоматизовано тестирање захтева скупове података који поштују структурна и релациона ограничења. Приступи генерисању података за тестирање ослањају се на писање императивног програмског кода или коришћење графичких корисничких интерфејса (енг. _Graphical User Interface_, GUI). Језици специфични за домен (енг. _Domain-Specific Language_, DSL) нуде алтернативу кроз висок ниво апстракције, омогућавајући инжењерима фокусирање на структуру података уместо на алгоритам њихове синтезе @fowler2011dsl. Успешна примена DSL-а зависи од квалитета пратећих развојних алата. Протокол језичких сервера (енг. _Language Server Protocol_, LSP) представља стандард који омогућава централизовани развој функција за анализу и обраду кода. LSP премошћује јаз између DSL-a и развојних окружења @lspspec.

== Мотивација
Постојећи алати за генерацију података захтевају компромис између експресивности и једноставности употребе. Писање наменских скрипти одузима време и отежава одржавање, док визуелни алати ограничавају могућност верзионисања и аутоматизације. Увођење новог DSL-а наилази на отпор програмера уколико језик не пружа помоћ при писању кода @voelter2013dsl. Креирање наменских додатака за свако појединачно развојно окружење захтева додатне ресурсе @rodriguezecheverria2018lsp. Стандардизација комуникације путем LSP-а омогућава развој интегрисаних система где једна имплементација језичког сервера пружа конзистентно развојно искуство, дијагностику и аутоматско допуњавање кода @bork2023lsp.

== Предмет и циљ рада
Предмет рада чине дизајн и имплементација DSL-a намењеног генерисању тест података. Рад обухвата развој прилагођеног преводиоца (енг. _compiler_) и пратећег језичког сервера који анализира изворни код. Циљ рада је унапређење ефикасности инжењера током процеса развоја софтвера кроз пружање специјализованог алата. Развијени систем треба да омогући дефинисање модела података уз детекцију семантичких грешака у реалном времену, навигацију кроз дефиниције симбола и интелигентно допуњавање кода.
